    ...
    <section id="lessons" className="py-12 md:py-20 px-4 bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 shadow-lg hover:shadow-yellow-500/20 bg-gradient-to-br from-yellow-50 to-orange-50 md:col-span-2 lg:col-span-2">
            <CardHeader className="text-center pb-4">
