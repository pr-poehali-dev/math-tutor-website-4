...
const Index = () => {
  ...
  const reviews = [
    ...
    },
    {
      name: "Алексей",
      role: "девятиклассник",
      text: "Занимаюсь с Ильей уже полгода. Математика стала понятной! Раньше боялся контрольных, а теперь решаю задачи с удовольствием. На последней олимпиаде даже призовое место занял! 🏆"
    }
  ];
